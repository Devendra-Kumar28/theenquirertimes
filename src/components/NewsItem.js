      ...
      <div className ="my-3">
        ...
        <span className ="position-absolute top-0  translate-middle badge rounded-pill " style={{ backgroundColor: '#DB0007' , left:'90%', zIndex:'1' }}>
          ...
          <div className="card-body">
            ...
            <a href={url} target=' _blank ' className="btn btn-dark btn-sm"  >Read More<svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" className="bi bi-chevron-double-right" viewBox="0 0 16 16">
